		...
		<ul class="form-section page-section">
			...
			<li class="form-line">
				...
				<div id="cid_4" class="form-input">
					<input type="text" id="name_product" name="name_product" class="form-textbox" value="<?php echo $data["name"]?>"/>
				</div>
			</li>
			<li class="form-line">
			...
			<li class="form-line" style="display: flex;">
				...
				<div class="form-img-edit" style="width: 100px; height: 100px;">
					<?php
						if (!empty($data["image"])) { ?>
							<img src="<?php upload($data["image"]); ?>" alt=""  style="width: 100px; margin-top: -50px">
						<?php } ?>
				</div>
			</li>
			<li class="form-line" >
				...
				<div class="form-input">
					<input type="number" id="price" name="price" data-type="input-number" 
					class="form-textbox"style="width:60px" size="5" value="<?php echo $data["price"]?>" placeholder="ex: $5">
				</div>
			</li>
